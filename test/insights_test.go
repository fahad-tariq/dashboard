...
func TestVelocityInsight_String(t *testing.T) {
	tests := []struct {
		...
		{"zero", insights.VelocityInsight{ThisWeek: 0, LastWeek: 0}, "No completions recently."},
		{"only this week", insights.VelocityInsight{ThisWeek: 3, LastWeek: 0}, "3 completed this week."},
		{"up", insights.VelocityInsight{ThisWeek: 5, LastWeek: 3}, "5 completed this week, up from 3 last week."},
		{"down", insights.VelocityInsight{ThisWeek: 2, LastWeek: 5}, "2 completed this week, down from 5 last week."},
		{"same", insights.VelocityInsight{ThisWeek: 3, LastWeek: 3}, "3 completed this week, same as last week."},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
